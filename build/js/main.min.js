...
/* harmony import */ var _modules_init_link_markup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-link-markup */ "./js/modules/init-link-markup.js");
/* harmony import */ var _modules_init_city_search__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-city-search */ "./js/modules/init-city-search.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_link_markup__WEBPACK_IMPORTED_MODULE_4__["initLinkMarkup"])();
    Object(_modules_init_move_to__WEBPACK_IMPORTED_MODULE_3__["initMoveTo"])();
    Object(_modules_init_city_search__WEBPACK_IMPORTED_MODULE_5__["initCitySearch"])();
  });
});
...
/*!****************************************!*\
  !*** ./js/modules/init-city-search.js ***!
  \****************************************/
/*! exports provided: initCitySearch */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCitySearch", function() { return initCitySearch; });
var input = document.querySelector('.search-form__input input');
var linksArr = document.querySelectorAll('.cities__list a');
var asideList = document.querySelector('.aside__list');
var form = document.querySelector('.search-form form');
var blockAside = function blockAside() {
  if (input.value) {
...
var initCitySearch = function initCitySearch() {
  input.addEventListener('input', function () {
    blockAside();
    var inputTo = input.value.toUpperCase();
    var i = inputTo.length;
    linksArr.forEach(function (link) {
      var linkTo = link.innerHTML.toUpperCase();
      var slis = linkTo.slice(0, i);
      if (slis === inputTo) {
...
/*!****************************************!*\
  !*** ./js/modules/init-link-markup.js ***!
  \****************************************/
/*! exports provided: initLinkMarkup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initLinkMarkup", function() { return initLinkMarkup; });
var alphabetId = ['city-a', 'city-b', 'city-v', 'city-g', 'city-d', 'city-e', 'city-zh', 'city-z', 'city-i', 'city-k', 'city-j', 'city-l', 'city-m', 'city-n', 'city-o', 'city-p', 'city-r', 'city-s', 'city-t', 'city-u', 'city-f', 'city-h', 'city-c', 'city-ch', 'city-sh', 'city-eh', 'city-ju', 'city-ja'];
var alphabetArr = ['А', 'Б', 'В', 'Г', 'Д', 'Е', 'Ж', 'З', 'И', 'Й', 'К', 'Л', 'М', 'Н', 'О', 'П', 'Р', 'С', 'Т', 'У', 'Ф', 'Х', 'Ц', 'Ч', 'Ш', 'Э', 'Ю', 'Я'];
var linksArr = document.querySelectorAll('.cities__list a');
var counter = 0;
var initLinkMarkup = function initLinkMarkup() {
  linksArr.forEach(function (link) {
...
var initMoveTo = function initMoveTo() {
  ...
  triggers.forEach(function (trigger) {
    var target = document.querySelector(trigger.dataset.trigger);
